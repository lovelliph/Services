          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="influencer-ugc">Influencer & UGC Management</option>
                <option value="creative-production">Creative Production</option>
                <option value="digital-marketing">Digital Marketing</option>
                <option value="consultation">Free Consultation & Strategy</option>
              </select>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="flex-1 bg-gray-900 text-white px-6 py-3 rounded-lg hover:bg-black transition-colors font-semibold flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  'Submitting...'
                ) : (
